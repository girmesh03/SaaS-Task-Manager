 ...
 *
 * This file is an EXACT copy of backend/utils/constants.js
 * Any changes to backend constants MUST be reflected here
 *
 * Requirements: 35.1, 35.2, 35.6, 35.7, 35.8, 35.9
 */
...
export const SOFT_DELETE_ERRORS = {
  ...
  NOTIFICATION_NOT_RESTORABLE: "NOTIFICATION_NOT_RESTORABLE",
